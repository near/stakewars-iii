...
Download the latest genesis file instead
```
cd ~/.near
wget https://s3-us-west-1.amazonaws.com/build.nearprotocol.com/nearcore-deploy/shardnet/genesis.json
```

**IMPORTANT: IGNORE BELOW FOR NOW**
...
If the above fails, AWS CLI may be oudated in your distribution repository. Instead, try installing:
```
